    ...
    <div className="sm:w-3/6 w-4/5 lg:w-3/4 mx-auto flex flex-wrap">
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex border-t-2 border-gray-100 mt-10">
          ...
          <button onClick={()=>{addToCart(slug, 1, 499, product.title); cartSuccess()}} className="flex ml-2 sm:ml-10 text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Add to Cart</button>
