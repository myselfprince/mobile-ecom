...
export default function Page({addToCart}) {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto object-cover object-center rounded" src="https://m.media-amazon.com/images/I/41PMrVjsowL._SX300_SY300_QL70_FMwebp_.jpg" />
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="mt-9 w-2/4 text-gray-600 flex items-center justify-start">
           ...
           Check
            ...
            <div className='mt-3'>
              {(!service && service!=null) && <p className='text-red-600'>We can't deliver to this pincode</p>}
